...
(function($){
    ...
    var settings = $.extend({
			...
			initButtonText: 		gettext('Send feedback'),
			strokeStyle:			'black',
			shadowColor:			'black',
			shadowOffsetX:			1,
			shadowOffsetY:			1,
			...
			tpl: {
				description:	'<div id="feedback-welcome"><div class="feedback-logo">' + gettext('Feedback') + '</div><p>' + gettext('Feedback lets you send us suggestions about our products. We welcome problem reports, feature ideas and general comments.') + '</p><p>' + gettext('Start by writing a brief description:') + '</p><textarea id="feedback-note-tmp"></textarea><p>' + gettext('Next we\'ll let you identify areas of the page related to your description.') + '</p><button id="feedback-welcome-next" class="feedback-next-btn feedback-btn-gray">' + gettext('Next') + '</button><div id="feedback-welcome-error">' + gettext('Please enter a description.') + '</div><div class="feedback-wizard-close"></div></div>',
				highlighter:	'<div id="feedback-highlighter"><div class="feedback-logo">' + gettext('Feedback') + '</div><p>' + gettext('Click and drag on the page to help us better understand your feedback. You can move this dialog if it\'s in the way.') + '</p><button class="feedback-sethighlight feedback-active"><div class="ico"></div><span>' + gettext('Highlight') + '</span></button><label>' + gettext('Highlight areas relevant to your feedback.') + '</label><button class="feedback-setblackout"><div class="ico"></div><span>' + gettext('Black out') + '</span></button><label class="lower">' + gettext('Black out any personal information.') + '</label><div class="feedback-buttons"><button id="feedback-highlighter-next" class="feedback-next-btn feedback-btn-gray">' + gettext('Next') + '</button><button id="feedback-highlighter-back" class="feedback-back-btn feedback-btn-gray">' + gettext('Back') + '</button></div><div class="feedback-wizard-close"></div></div>',
				overview:		'<div id="feedback-overview"><div class="feedback-logo">' + gettext('Feedback') + '</div><div id="feedback-overview-description"><div id="feedback-overview-description-text"><h3>' + gettext('Description') + '</h3><h3 class="feedback-additional">' + gettext('Additional info') + '</h3><div id="feedback-additional-none"><span>' + gettext('None') + '</span></div><div id="feedback-browser-info"><span>' + gettext('Browser Info') + '</span></div><div id="feedback-page-info"><span>' + gettext('Page Info') + '</span></div><div id="feedback-page-structure"><span>' + gettext('Page Structure') + '</span></div></div></div><div id="feedback-overview-screenshot"><h3>' + gettext('Screenshot') + '</h3></div><div class="feedback-buttons"><button id="feedback-submit" class="feedback-submit-btn feedback-btn-blue">' + gettext('Submit') + '</button><button id="feedback-overview-back" class="feedback-back-btn feedback-btn-gray">' + gettext('Back') + '</button>{% csrf_token %}</div><div id="feedback-overview-error">' + gettext('Please enter a description.') + '</div><div class="feedback-wizard-close"></div></div>',
				submitSuccess:	'<div id="feedback-submit-success"><div class="feedback-logo">' + gettext('Feedback') + '</div><p>' + gettext('Thank you for your feedback. We value every piece of feedback we receive.') + '</p><p>' + gettext('We cannot respond individually to every one, but we will use your comments as we strive to improve your experience.') + '</p><button class="feedback-close-btn feedback-btn-blue">' + gettext('OK') + '</button><div class="feedback-wizard-close"></div></div>',
				submitError:	'<div id="feedback-submit-error"><div class="feedback-logo">' + gettext('Feedback') + '</div><p>' + gettext('Sadly an error occurred while sending your feedback. Please try again.') + '</p><button class="feedback-close-btn feedback-btn-blue">' + gettext('OK') + '</button><div class="feedback-wizard-close"></div></div>'
			},
			onClose: 				function() {},
