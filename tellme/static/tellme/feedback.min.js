    ...
    e.feedback = function(t) {
        ...
        function u(t, n) {
            ...
            e(".feedback-helper").each(function() {
                if (e(this).attr("data-type") == "highlight")
                    if (n) a(t, parseInt(e(this).css("left"), 10), parseInt(e(this).css("top"), 10), e(this).width(), e(this).height())
            });
            e(".feedback-helper").each(function() {
        ...
        if (r) {
            ...
            e(document).on("click", n.feedbackButton, function() {
                ...
                c += n.tpl.highlighter + n.tpl.overview + '<canvas id="feedback-canvas"></canvas><div id="feedback-helpers"></div><input id="feedback-note" name="feedback-note" type="hidden"></div>';
                e("body").append(c);
                moduleStyle = {
                    position: "absolute",
                    left: "0px",
                ...
                var h = e("#feedback-canvas")[0].getContext("2d");
                h.fillStyle = "rgba(102,102,102,0.5)";
                h.fillRect(0, 0, e("#feedback-canvas").width(), e("#feedback-canvas").height());
                rect = {};
                drag = false;
                highlight = 1, post = {};
                ...
                e(document).on("mousemove", function(n) {
                    if (t && drag) {
                        ...
                        h.clearRect(0, 0, e("#feedback-canvas").width(), e("#feedback-canvas").height());
                        h.fillStyle = "rgba(102,102,102,0.5)";
                        h.fillRect(0, 0, e("#feedback-canvas").width(), e("#feedback-canvas").height());
                        e(".feedback-helper").each(function() {
                            if (e(this).attr("data-type") == "highlight") a(h, parseInt(e(this).css("left"), 10), parseInt(e(this).css("top"), 10), e(this).width(), e(this).height())
                        });
                        if (highlight == 1) {
                            a(h, rect.startX, rect.startY, rect.w, rect.h);
                            h.clearRect(rect.startX, rect.startY, rect.w, rect.h)
                        }
                        e(".feedback-helper").each(function() {
                            if (e(this).attr("data-type") == "highlight") h.clearRect(parseInt(e(this).css("left"), 10), parseInt(e(this).css("top"), 10), e(this).width(), e(this).height())
                        });
                        e(".feedback-helper").each(function() {
                            if (e(this).attr("data-type") == "blackout") {
                                h.fillStyle = "rgba(0,0,0,1)";
                                h.fillRect(parseInt(e(this).css("left"), 10), parseInt(e(this).css("top"), 10), e(this).width(), e(this).height())
                            }
                        });
                        if (highlight == 0) {
                            h.fillStyle = "rgba(0,0,0,0.5)";
                            h.fillRect(rect.startX, rect.startY, rect.w, rect.h)
                        }
                    }
                });
                if (n.highlightElement) {
                        ...
                        if (t) {
                            ...
                            if (r && !drag) {
                                ...
                                var i = r.offset().left - 2,
                                    s = r.offset().top - 2,
                                    o = r.width() + parseInt(r.css("padding-left"), 10) + parseInt(r.css("padding-right"), 10) + 6,
                                ...
                                if (n.type == "click" && n.pageX == rect.startX && n.pageY == rect.startY) {
                                    e("#feedback-helpers").append('<div class="feedback-helper" data-highlight-id="' + v + '" data-type="' + dtype + '" data-time="' + Date.now() + '" style="position:absolute;top:' + s + "px;left:" + i + "px;width:" + o + "px;height:" + f + 'px;z-index:30000;"></div>');
                                    p.push(v);
                                    ++v;
                                    u(h)
                                }
                ...
                e(document).on("mouseenter mouseleave", ".feedback-helper", function(t) {
                    ...
                    if (t.type === "mouseenter") {
                        ...
                        if (e(this).attr("data-type") == "blackout") {
                            ...
                            h.clearRect(parseInt(e(this).css("left"), 10), parseInt(e(this).css("top"), 10), e(this).width(), e(this).height());
                            h.fillStyle = "rgba(0,0,0,0.75)";
                            h.fillRect(parseInt(e(this).css("left"), 10), parseInt(e(this).css("top"), 10), e(this).width(), e(this).height());
                ...
                e(document).on("click", "#feedback-highlighter-next", function() {
                    ...
                    html2canvas(e("body"), {
                        onrendered: function(t) {
                            ...
                            _canvas = e('<canvas id="feedback-canvas-tmp" width="' + l + '" height="' + s + '"/>').hide().appendTo("body");
                            _ctx = _canvas.get(0).getContext("2d");
                            _ctx.drawImage(t, 0, 0, l, s, 0, 0, l, s);
                            r = _canvas.get(0).toDataURL();
                            e(document).scrollTop(i);
                            post.img = r;
                            n.onScreenshotTaken(post.img);
                            if (n.showDescriptionModal) {
                                ...
                                e("#feedback-overview-screenshot").append('<img class="feedback-screenshot" src="' + r + '" />')
                            } else {
                                e("#feedback-module").remove();
                                o();
                                _canvas.remove()
                ...
                e(document).on("keyup", "#feedback-note-tmp,#feedback-overview-note", function(t) {
                    var n;
                    if (t.target.id === "feedback-note-tmp")
                        n = e("#feedback-note-tmp").val();
                    else {
                ...
                e(document).on("click", "#feedback-submit", function() {
                    ...
                    if (e("#feedback-note").val().length > 0) {
                        ...
                        e("#feedback-overview").hide();
                        if (e("#feedback-user-email").val()){
                            post.email = e("#feedback-user-email").val();
                        }
                        post.img = r;
